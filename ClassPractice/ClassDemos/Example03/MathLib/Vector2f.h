...
struct MathLib_API Vector2f final
{
	// -------------------------
	// Constructors 
	// -------------------------
...
// -------------------------
MathLib_API Vector2f operator*( float lhs, Vector2f rhs );
MathLib_API Vector2f operator*( Vector2f lhs, float rhs );
MathLib_API Vector2f operator/( Vector2f lhs, float rhs );

MathLib_API Vector2f operator+( Vector2f lhs, const Vector2f& rhs );
MathLib_API Vector2f operator-( Vector2f lhs, const Vector2f& rhs );

MathLib_API bool operator==( const Vector2f& lhs, const Vector2f& rhs );
MathLib_API bool operator!=( const  Vector2f& lhs, const Vector2f& rhs );

MathLib_API std::ostream& operator<< ( std::ostream& lhs, const Vector2f& rhs );
