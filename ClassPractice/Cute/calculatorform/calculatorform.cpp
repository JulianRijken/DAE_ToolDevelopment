...
{
    m_ui.setupUi(this);
    connect(m_ui.inputSpinBox1, &QSpinBox::valueChanged, this, &CalculatorForm::on_inputSpinBox1_Changed);
    connect(m_ui.inputSpinBox2, &QSpinBox::valueChanged, this, &CalculatorForm::on_inputSpinBox2_Changed);
}
